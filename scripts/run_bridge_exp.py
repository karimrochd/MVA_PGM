...
LR = 1e-3
# CHANGE 1: Increase training time for convergence
EPOCHS = 50 
BATCH_SIZE = 64
# CHANGE 2: Larger initial sigma to better bridge modes (mix better)
SIGMA_BEGIN = 5.0 
SIGMA_END = 0.01
NUM_SIGMAS = 10
...
def main():
    ...
    # CHANGE 3: Increase n_steps_each for better refinement
    ...
    output_filename = 'bridge_experiment_mnist_improved.png'
