...
% Figures and tables from both papers, results description, trends and comparative discussion.

% ========================
\section{Discussion and Limitations}
% Strengths, weaknesses, stability, runtime, sigma ladder, connections to later work.

% ========================
\section{Conclusion}
% Summary of conceptual link: Vincent -> NCSN -> generative sampling.

% ========================
\section*{References}
% Hyvärinen (2005), Vincent (2011), Song & Ermon (2019)
